  ...
  return <>
    ...
    <div className={`${isFBApp ? 'text-lg' : 'text-xl'} px-2 sm:px-4 flex !flex-col sm:!flex-row`}>
      <div style={{ flexWrap: 'wrap', columnGap: '20px', rowGap: '2px' }} className={`${isFBApp ? 'text-xs' : 'text-sm'} wrapper_under_image flex flex-row items-center justify-center px-3 sm:px-0 sm:flex-col sm:justify-start`}>
        ...
        <p className="text-nowrap flex flex-row justify-center items-center sm:mt-1">{langCV.nationality[l]}: {isTH ? 'ไทย' : 'Thai'} <img src="v2/img/thai_flag.jpg" className="m-auto ml-1" style={{ width: '22px' }} /></p>
      ...
      <div style={{ position: 'relative' }} className="flex flex-col cv_content text-lg p-4 sm:pt-0">
        ...
        <div className="professional_summary_wrapper indent-8 text-sm py-4 sm:pl-4 pb-5 text-justify">
          ...
          <div class="container-right right-t">
            <div class="content-right p-5">
              ...
              <div className="flex flex-row flex-wrap text-base pb-2" style={{ columnGap: '2px', rowGap:'2px' }}>
                ...
                <div className="basis-full"></div>
                <div className="flex flex-row text-sm sm:text-base">
                  <span className="text-nowrap indent-8"><i class='fa-solid fa-calendar-alt'></i></span>
